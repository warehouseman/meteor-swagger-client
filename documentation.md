...
* [meteor-swagger-client](#module_meteor-swagger-client)
  ...
  * [~getSwaggerProxy()](#module_meteor-swagger-client..getSwaggerProxy) ⇒ <code>Swagger</code>
  * [~attachSyncMethods(host)](#module_meteor-swagger-client..attachSyncMethods) ⇒ <code>void</code>
...
This is an exported global data structure able to hold proxies of numerous
remote REST API hosts.  The original asynchronous methods generated by the
NodeJS module 'swagger-client' are available as is, but also available
...
<a name="module_meteor-swagger-client..getSwaggerProxy"></a>
### meteor-swagger-client~getSwaggerProxy() ⇒ <code>Swagger</code>
'getSwaggerProxy' wraps the asynchronous Swagger constructor such
that a Swagger proxy is returned to the caller.  This method is used by
SwaggerClients.addRemoteHost(), but it may also be called directly.  Its
methods will have to be used in asynchronous fashion.

**Kind**: inner method of <code>[meteor-swagger-client](#module_meteor-swagger-client)</code>  
**Access:** public  
<a name="module_meteor-swagger-client..attachSyncMethods"></a>
### meteor-swagger-client~attachSyncMethods(host) ⇒ <code>void</code>
Iterates through all the API entities of the provided host
...
| Param | Type | Description |
| --- | --- | --- |
| host | <code>swagger</code> | A remote host proxy generated by swagger-client. |
